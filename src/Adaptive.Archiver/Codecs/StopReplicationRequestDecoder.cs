...
public class StopReplicationRequestDecoder
{
    ...
    private StopReplicationRequestDecoder _parentMessage;
    ...
    public StopReplicationRequestDecoder()
    {
        _parentMessage = this;
    }
    ...
    public StopReplicationRequestDecoder Wrap(
    ...
    public static int ReplicationIdId()
    {
        return 3;
    }

    public static int ReplicationIdSinceVersion()
    {
        return 0;
    }
    ...
    public static string ReplicationIdMetaAttribute(MetaAttribute metaAttribute)
    {
        switch (metaAttribute)
        {
            case MetaAttribute.EPOCH: return "unix";
    ...
    public StringBuilder AppendTo(StringBuilder builder)
    {
        ...
        builder.Append("[StopReplicationRequest](sbeTemplateId=");
        ...
        builder.Append(CorrelationId());
        builder.Append('|');
        //Token{signal=BEGIN_FIELD, name='replicationId', referencedName='null', description='null', id=3, version=0, deprecated=0, encodedLength=0, offset=16, componentTokenCount=3, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond, semanticType='null'}}
