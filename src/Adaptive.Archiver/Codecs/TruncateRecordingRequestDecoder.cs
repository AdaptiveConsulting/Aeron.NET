...
public class TruncateRecordingRequestDecoder
{
    ...
    private TruncateRecordingRequestDecoder _parentMessage;
    ...
    public TruncateRecordingRequestDecoder()
    {
        _parentMessage = this;
    }
    ...
    public TruncateRecordingRequestDecoder Wrap(
    ...
    public StringBuilder AppendTo(StringBuilder builder)
    {
        ...
        builder.Append("[TruncateRecordingRequest](sbeTemplateId=");
