...
public class RecordingSubscriptionDescriptorDecoder
{
    ...
    private RecordingSubscriptionDescriptorDecoder _parentMessage;
    ...
    public RecordingSubscriptionDescriptorDecoder()
    {
        _parentMessage = this;
    }
    ...
    public RecordingSubscriptionDescriptorDecoder Wrap(
    ...
    public StringBuilder AppendTo(StringBuilder builder)
    {
        ...
        builder.Append("[RecordingSubscriptionDescriptor](sbeTemplateId=");
