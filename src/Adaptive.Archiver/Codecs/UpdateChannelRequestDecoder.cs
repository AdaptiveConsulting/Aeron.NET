...
public class UpdateChannelRequestDecoder
{
    ...
    private UpdateChannelRequestDecoder _parentMessage;
    ...
    public UpdateChannelRequestDecoder()
    {
        _parentMessage = this;
    }
    ...
    public UpdateChannelRequestDecoder Wrap(
    ...
    public StringBuilder AppendTo(StringBuilder builder)
    {
        ...
        builder.Append("[UpdateChannelRequest](sbeTemplateId=");
