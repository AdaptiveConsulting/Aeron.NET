...
public class StopRecordingRequestEncoder
{
    ...
    private StopRecordingRequestEncoder _parentMessage;
    private IMutableDirectBuffer _buffer;
    protected int _offset;
    protected int _limit;

    public StopRecordingRequestEncoder()
    {
        _parentMessage = this;
    }
    ...
    public StopRecordingRequestEncoder Wrap(IMutableDirectBuffer buffer, int offset)
    {
        this._buffer = buffer;
        this._offset = offset;
    ...
    public StopRecordingRequestEncoder WrapAndApplyHeader(
    ...
    public StopRecordingRequestEncoder ControlSessionId(long value)
    {
    ...
    public StopRecordingRequestEncoder CorrelationId(long value)
    {
    ...
    public StopRecordingRequestEncoder StreamId(int value)
    {
    ...
    public StopRecordingRequestEncoder PutChannel(IDirectBuffer src, int srcOffset, int length)
    {
    ...
    public StopRecordingRequestEncoder PutChannel(byte[] src, int srcOffset, int length)
    {
        if (length > 1073741824)
        {
            throw new InvalidOperationException("length > maxValue for type: " + length);
    ...
    public StopRecordingRequestEncoder Channel(string value)
    {
    ...
    {
        StopRecordingRequestDecoder writer = new StopRecordingRequestDecoder();
