...
public class RecordingSubscriptionDescriptorEncoder
{
    ...
    private RecordingSubscriptionDescriptorEncoder _parentMessage;
    ...
    public RecordingSubscriptionDescriptorEncoder Wrap(IMutableDirectBuffer buffer, int offset)
    {
        this._buffer = buffer;
        this._offset = offset;
    ...
    public RecordingSubscriptionDescriptorEncoder WrapAndApplyHeader(
    ...
    public RecordingSubscriptionDescriptorEncoder PutStrippedChannel(IDirectBuffer src, int srcOffset, int length)
    {
    ...
    {
        RecordingSubscriptionDescriptorDecoder writer = new RecordingSubscriptionDescriptorDecoder();
