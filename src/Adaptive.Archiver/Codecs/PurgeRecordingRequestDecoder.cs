...
public class PurgeRecordingRequestDecoder
{
    ...
    private PurgeRecordingRequestDecoder _parentMessage;
    ...
    public PurgeRecordingRequestDecoder()
    {
        _parentMessage = this;
    }
    ...
    public PurgeRecordingRequestDecoder Wrap(
    ...
    public StringBuilder AppendTo(StringBuilder builder)
    {
        ...
        builder.Append("[PurgeRecordingRequest](sbeTemplateId=");
