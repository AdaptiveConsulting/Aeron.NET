...
public class StopRecordingSubscriptionRequestDecoder
{
    ...
    private StopRecordingSubscriptionRequestDecoder _parentMessage;
    ...
    public StopRecordingSubscriptionRequestDecoder()
    {
        _parentMessage = this;
    }
    ...
    public StopRecordingSubscriptionRequestDecoder Wrap(
    ...
    public StringBuilder AppendTo(StringBuilder builder)
    {
        ...
        builder.Append("[StopRecordingSubscriptionRequest](sbeTemplateId=");
        ...
        builder.Append(CorrelationId());
        builder.Append('|');
        //Token{signal=BEGIN_FIELD, name='subscriptionId', referencedName='null', description='null', id=2, version=0, deprecated=0, encodedLength=0, offset=16, componentTokenCount=3, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond, semanticType='null'}}
