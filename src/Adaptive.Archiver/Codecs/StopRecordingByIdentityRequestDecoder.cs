...
public class StopRecordingByIdentityRequestDecoder
{
    ...
    private StopRecordingByIdentityRequestDecoder _parentMessage;
    ...
    public StopRecordingByIdentityRequestDecoder()
    {
        _parentMessage = this;
    }
    ...
    public StopRecordingByIdentityRequestDecoder Wrap(
    ...
    public StringBuilder AppendTo(StringBuilder builder)
    {
        ...
        builder.Append("[StopRecordingByIdentityRequest](sbeTemplateId=");
