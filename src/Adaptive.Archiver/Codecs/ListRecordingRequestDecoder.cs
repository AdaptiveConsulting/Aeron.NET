...
public class ListRecordingRequestDecoder
{
    ...
    public ListRecordingRequestDecoder()
    {
        _parentMessage = this;
    }
    ...
    public ListRecordingRequestDecoder Wrap(
    ...
    public StringBuilder AppendTo(StringBuilder builder)
    {
        ...
        builder.Append("[ListRecordingRequest](sbeTemplateId=");
