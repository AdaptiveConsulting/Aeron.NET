...
public class MaxRecordedPositionRequestDecoder
{
    ...
    private MaxRecordedPositionRequestDecoder _parentMessage;
    ...
    public MaxRecordedPositionRequestDecoder()
    {
        _parentMessage = this;
    }
    ...
    public MaxRecordedPositionRequestDecoder Wrap(
    ...
    public StringBuilder AppendTo(StringBuilder builder)
    {
        ...
        builder.Append("[MaxRecordedPositionRequest](sbeTemplateId=");
