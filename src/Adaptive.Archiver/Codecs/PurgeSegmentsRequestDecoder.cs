...
public class PurgeSegmentsRequestDecoder
{
    ...
    private PurgeSegmentsRequestDecoder _parentMessage;
    ...
    public PurgeSegmentsRequestDecoder()
    {
        _parentMessage = this;
    }
    ...
    public PurgeSegmentsRequestDecoder Wrap(
    ...
    public static int NewStartPositionId()
    {
        return 4;
    }

    public static int NewStartPositionSinceVersion()
    {
        return 0;
    }
    ...
    public static string NewStartPositionMetaAttribute(MetaAttribute metaAttribute)
    {
        switch (metaAttribute)
        {
            case MetaAttribute.EPOCH: return "unix";
    ...
    public StringBuilder AppendTo(StringBuilder builder)
    {
        ...
        builder.Append("[PurgeSegmentsRequest](sbeTemplateId=");
        ...
        builder.Append(RecordingId());
        builder.Append('|');
        //Token{signal=BEGIN_FIELD, name='newStartPosition', referencedName='null', description='null', id=4, version=0, deprecated=0, encodedLength=0, offset=24, componentTokenCount=3, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond, semanticType='null'}}
        ...
        builder.Append("NewStartPosition=");
        builder.Append(NewStartPosition());
