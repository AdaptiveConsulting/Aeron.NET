...
public class DetachSegmentsRequestDecoder
{
    ...
    public DetachSegmentsRequestDecoder()
    {
        _parentMessage = this;
    }
    ...
    public DetachSegmentsRequestDecoder Wrap(
    ...
    public StringBuilder AppendTo(StringBuilder builder)
    {
        ...
        builder.Append("[DetachSegmentsRequest](sbeTemplateId=");
