...
public class ReplayTokenRequestDecoder
{
    ...
    private ReplayTokenRequestDecoder _parentMessage;
    ...
    public ReplayTokenRequestDecoder()
    {
        _parentMessage = this;
    }
    ...
    public ReplayTokenRequestDecoder Wrap(
    ...
    public StringBuilder AppendTo(StringBuilder builder)
    {
        ...
        builder.Append("[ReplayTokenRequest](sbeTemplateId=");
