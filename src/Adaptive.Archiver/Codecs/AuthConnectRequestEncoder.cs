...
public class AuthConnectRequestEncoder
{
    ...
    private AuthConnectRequestEncoder _parentMessage;
    private IMutableDirectBuffer _buffer;
    protected int _offset;
    protected int _limit;

    public AuthConnectRequestEncoder()
    {
        _parentMessage = this;
    }
    ...
    public AuthConnectRequestEncoder Wrap(IMutableDirectBuffer buffer, int offset)
    {
        this._buffer = buffer;
        this._offset = offset;
    ...
    public AuthConnectRequestEncoder WrapAndApplyHeader(
    ...
    public AuthConnectRequestEncoder Version(int value)
    {
    ...
    public AuthConnectRequestEncoder PutResponseChannel(IDirectBuffer src, int srcOffset, int length)
    {
    ...
    public AuthConnectRequestEncoder PutResponseChannel(byte[] src, int srcOffset, int length)
    {
        if (length > 1073741824)
        {
            throw new InvalidOperationException("length > maxValue for type: " + length);
    ...
    public AuthConnectRequestEncoder ResponseChannel(string value)
    {
    ...
    public AuthConnectRequestEncoder PutEncodedCredentials(IDirectBuffer src, int srcOffset, int length)
    {
        if (length > 1073741824)
        {
            throw new InvalidOperationException("length > maxValue for type: " + length);
    ...
    public AuthConnectRequestEncoder PutEncodedCredentials(byte[] src, int srcOffset, int length)
    {
        if (length > 1073741824)
        {
            throw new InvalidOperationException("length > maxValue for type: " + length);
    ...
    public AuthConnectRequestEncoder PutClientInfo(IDirectBuffer src, int srcOffset, int length)
    {
        if (length > 1073741824)
        {
            throw new InvalidOperationException("length > maxValue for type: " + length);
    ...
    public AuthConnectRequestEncoder PutClientInfo(byte[] src, int srcOffset, int length)
    {
        if (length > 1073741824)
        {
            throw new InvalidOperationException("length > maxValue for type: " + length);
    ...
    public AuthConnectRequestEncoder ClientInfo(string value)
    {
        int length = value.Length;
        if (length > 1073741824)
        {
    ...
    {
        AuthConnectRequestDecoder writer = new AuthConnectRequestDecoder();
