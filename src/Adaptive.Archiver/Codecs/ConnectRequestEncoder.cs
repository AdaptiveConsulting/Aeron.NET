...
public class ConnectRequestEncoder
{
    ...
    public ConnectRequestEncoder Wrap(IMutableDirectBuffer buffer, int offset)
    {
        this._buffer = buffer;
        this._offset = offset;
    ...
    public ConnectRequestEncoder WrapAndApplyHeader(
    ...
    public ConnectRequestEncoder PutResponseChannel(IDirectBuffer src, int srcOffset, int length)
    {
