...
public class AuthConnectRequestDecoder
{
    ...
    public AuthConnectRequestDecoder()
    {
        _parentMessage = this;
    }
    ...
    public AuthConnectRequestDecoder Wrap(
    ...
    {
        if (_parentMessage._actingVersion < 12)
        {
            return 0;
        }
    ...
    public StringBuilder AppendTo(StringBuilder builder)
    {
        ...
        builder.Append("[AuthConnectRequest](sbeTemplateId=");
        ...
        builder.Append('|');
        //Token{signal=BEGIN_VAR_DATA, name='clientInfo', referencedName='null', description='null', id=6, version=12, deprecated=0, encodedLength=0, offset=-1, componentTokenCount=6, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond, semanticType='null'}}
