...
namespace Adaptive.Cluster.Service
{
    ...
    /// <para>
    /// The {@code cluster} object should only be used to send messages to the cluster or schedule timers in response to
    /// other messages and timers. Sending messages and timers should not happen from cluster lifecycle methods like
    /// <seealso cref="OnStart(ICluster, Image)"/> , <seealso cref="OnRoleChange(ClusterRole)"/> or
    /// <seealso cref="OnTakeSnapshot(ExclusivePublication)"/>, or <seealso cref="OnTerminate(ICluster)"/>, except the
    ...
    {
        /// <summary>
        /// Start event where the service can perform any initialisation required and load snapshot state. The snapshot
        /// image can be null if no previous snapshot exists.
        /// <para>
        /// <b>Note:</b> As this is a potentially long-running operation the implementation should use
        /// <seealso cref="ICluster.IdleStrategy()"/> and then occasionally call <seealso cref="IIdleStrategy.Idle()"/>
        /// or
        ...
        /// <param name="snapshotImage"> from which the service can load its archived state which can be null when no
        /// snapshot. </param>
        ...
        /// <seealso cref="ICluster.IdleStrategy()"/> and then occasionally call <seealso cref="IIdleStrategy.Idle()"/>
        /// or
        /// <seealso cref="IIdleStrategy.Idle(int)"/>, especially when the <seealso cref="ExclusivePublication"/>
        /// returns <seealso cref="Publication.BACK_PRESSURED"/> .
        ///
        /// </para>
        /// </summary>
        ...
        /// <seealso cref="Cluster"/> which could update the log such as
        /// <seealso cref="ICluster.ScheduleTimer(long, long)"/> or
