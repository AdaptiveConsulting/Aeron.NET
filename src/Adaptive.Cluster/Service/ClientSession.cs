...
namespace Adaptive.Cluster.Service
{
    ...
    public interface IClientSession
    {
        ...
        /// <returns> the same as <seealso cref="Publication.Offer(IDirectBuffer, int, int, ReservedValueSupplier)"/>
        /// when in <seealso cref="ClusterRole.Leader"/> , otherwise <see cref="ClientSessionConstants.MOCKED_OFFER"/>
        /// when a follower. </returns>
        ...
        /// cluster egress header so must be left unused.
        /// </summary>
        /// <param name="vectors"> which make up the message. </param>
        /// <returns> the same as <seealso cref="Publication.Offer(DirectBufferVector[], ReservedValueSupplier)"/>.
        /// </returns>
        /// <seealso cref="Publication.Offer(DirectBufferVector[], ReservedValueSupplier)"/> when in
        /// <seealso cref="ClusterRole.Leader"/>,
        ...
        /// <pre>{@code final IDirectBuffer srcBuffer = AcquireMessage();
        ///
        ...
        /// </para>
        /// </summary>
        /// <param name="length"> of the range to claim in bytes. The additional bytes for the session header will be
        /// added. </param>
