...
namespace Adaptive.Cluster.Client
{
    ...
    public class IngressSessionDecorator
    {
        ...
        ///
        /// </summary>
        public static readonly int HEADER_LENGTH =
        ...
        private readonly UnsafeBuffer _headerBuffer = new UnsafeBuffer(new byte[HEADER_LENGTH]);

        /// <summary>
        /// Construct a new ingress session header wrapper that defaults all fields to the
        /// <see cref="Adaptive.Aeron.Aeron.NULL_VALUE"/>
        /// </summary>
        public IngressSessionDecorator()
            : this(Aeron.Aeron.NULL_VALUE, Aeron.Aeron.NULL_VALUE) { }
        ...
        public IngressSessionDecorator(long clusterSessionId, long leadershipTermId)
        {
            _sessionMessageHeaderEncoder
                .WrapAndApplyHeader(_headerBuffer, 0, new MessageHeaderEncoder())
        ...
        {
            _sessionMessageHeaderEncoder.ClusterSessionId(clusterSessionId);
            return this;
        }
        ...
        /// <para>
        /// This version of the method will set the timestamp value in the header to
        /// <see cref="Adaptive.Aeron.Aeron.NULL_VALUE"/> .
        ///
        /// </para>
        /// </summary>
        ...
        {
            return publication.Offer(_headerBuffer, 0, HEADER_LENGTH, buffer, offset, length);
        }
    }
}
