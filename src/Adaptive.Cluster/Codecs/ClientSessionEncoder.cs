...
public class ClientSessionEncoder
{
    ...
    public ClientSessionEncoder Wrap(IMutableDirectBuffer buffer, int offset)
    {
        this._buffer = buffer;
        this._offset = offset;
    ...
    public ClientSessionEncoder WrapAndApplyHeader(
    ...
    public ClientSessionEncoder ClusterSessionId(long value)
    {
    ...
    public ClientSessionEncoder PutResponseChannel(IDirectBuffer src, int srcOffset, int length)
    {
    ...
    public ClientSessionEncoder PutResponseChannel(byte[] src, int srcOffset, int length)
    {
        if (length > 1073741824)
        {
            throw new InvalidOperationException("length > maxValue for type: " + length);
    ...
    public ClientSessionEncoder ResponseChannel(string value)
    {
    ...
    {
        ClientSessionDecoder writer = new ClientSessionDecoder();
