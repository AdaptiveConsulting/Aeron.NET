...
public class SnapshotRecordingQueryDecoder
{
    ...
    private SnapshotRecordingQueryDecoder _parentMessage;
    ...
    public SnapshotRecordingQueryDecoder()
    {
        _parentMessage = this;
    }
    ...
    public SnapshotRecordingQueryDecoder Wrap(
    ...
    public StringBuilder AppendTo(StringBuilder builder)
    {
        ...
        builder.Append("[SnapshotRecordingQuery](sbeTemplateId=");
