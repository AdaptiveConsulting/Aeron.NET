...
public class IngressMessageHeaderDecoder
{
    ...
    private IngressMessageHeaderDecoder _parentMessage;
    ...
    public IngressMessageHeaderDecoder()
    {
        _parentMessage = this;
    }
    ...
    public StringBuilder AppendTo(StringBuilder builder)
    {
        ...
        builder.Append("[IngressMessageHeader](sbeTemplateId=");
