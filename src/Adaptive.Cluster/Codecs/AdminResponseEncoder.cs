...
public class AdminResponseEncoder
{
    ...
    public AdminResponseEncoder RequestType(AdminRequestType value)
    {
    ...
    public AdminResponseEncoder ResponseCode(AdminResponseCode value)
    {
    ...
    public AdminResponseEncoder PutMessage(IDirectBuffer src, int srcOffset, int length)
    {
    ...
    public AdminResponseEncoder PutMessage(byte[] src, int srcOffset, int length)
    {
        if (length > 1073741824)
        {
            throw new InvalidOperationException("length > maxValue for type: " + length);
    ...
    public AdminResponseEncoder Message(string value)
    {
    ...
    public AdminResponseEncoder PutPayload(IDirectBuffer src, int srcOffset, int length)
    {
        if (length > 1073741824)
        {
            throw new InvalidOperationException("length > maxValue for type: " + length);
    ...
    public AdminResponseEncoder PutPayload(byte[] src, int srcOffset, int length)
    {
        if (length > 1073741824)
        {
            throw new InvalidOperationException("length > maxValue for type: " + length);
