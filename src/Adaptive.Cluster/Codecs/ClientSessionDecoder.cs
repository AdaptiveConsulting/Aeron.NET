...
public class ClientSessionDecoder
{
    ...
    private ClientSessionDecoder _parentMessage;
    ...
    public ClientSessionDecoder Wrap(
    ...
    public StringBuilder AppendTo(StringBuilder builder)
    {
        ...
        builder.Append("[ClientSession](sbeTemplateId=");
