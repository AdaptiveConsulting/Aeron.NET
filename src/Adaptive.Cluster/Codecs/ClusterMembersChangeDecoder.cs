...
public class ClusterMembersChangeDecoder
{
    ...
    public ClusterMembersChangeDecoder()
    {
        _parentMessage = this;
    }
    ...
    public ClusterMembersChangeDecoder Wrap(
    ...
    public static int ActiveMembersSinceVersion()
    {
        return 0;
    }
    ...
    public int ActiveMembersLength()
    {
        int limit = _parentMessage.Limit();
        return (int)unchecked((uint)_buffer.GetInt(limit, ByteOrder.LittleEndian));
    }

    public int GetActiveMembers(IMutableDirectBuffer dst, int dstOffset, int length)
    {
        int headerLength = 4;
        int limit = _parentMessage.Limit();
    ...
    public int GetActiveMembers(byte[] dst, int dstOffset, int length)
    {
        int headerLength = 4;
        int limit = _parentMessage.Limit();
        int dataLength = (int)unchecked((uint)_buffer.GetInt(limit, ByteOrder.LittleEndian));
    ...
    public static int PassiveMembersId()
    {
        return 4;
    }

    public static int PassiveMembersSinceVersion()
    {
        return 0;
    }

    public static string PassiveMembersCharacterEncoding()
    {
        return "US-ASCII";
    }

    public static string PassiveMembersMetaAttribute(MetaAttribute metaAttribute)
    {
        switch (metaAttribute)
        {
            case MetaAttribute.EPOCH: return "unix";
    ...
    public static int PassiveMembersHeaderLength()
    {
        return 4;
    }

    public int PassiveMembersLength()
    {
        int limit = _parentMessage.Limit();
        return (int)unchecked((uint)_buffer.GetInt(limit, ByteOrder.LittleEndian));
    }

    public int GetPassiveMembers(IMutableDirectBuffer dst, int dstOffset, int length)
    {
        int headerLength = 4;
        int limit = _parentMessage.Limit();
        int dataLength = (int)unchecked((uint)_buffer.GetInt(limit, ByteOrder.LittleEndian));
    ...
    public int GetPassiveMembers(byte[] dst, int dstOffset, int length)
    {
        int headerLength = 4;
        int limit = _parentMessage.Limit();
        int dataLength = (int)unchecked((uint)_buffer.GetInt(limit, ByteOrder.LittleEndian));
    ...
    public StringBuilder AppendTo(StringBuilder builder)
    {
        ...
        builder.Append("[ClusterMembersChange](sbeTemplateId=");
