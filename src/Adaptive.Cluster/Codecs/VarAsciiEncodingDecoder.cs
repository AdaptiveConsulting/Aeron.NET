...
public class VarAsciiEncodingDecoder
{
    public static int ENCODED_LENGTH = -1;
    private int _offset;
    private IDirectBuffer _buffer;

    public VarAsciiEncodingDecoder Wrap(IDirectBuffer buffer, int offset)
    {
        this._buffer = buffer;
        this._offset = offset;
    ...
    public StringBuilder AppendTo(StringBuilder builder)
    {
        ...
        builder.Append(Length());
        builder.Append('|');
        //Token{signal=ENCODING, name='varData', referencedName='null', description='null', id=-1, version=0, deprecated=0, encodedLength=-1, offset=4, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=UINT8, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='US-ASCII', epoch='null', timeUnit=null, semanticType='null'}}
        builder.Append(')');
