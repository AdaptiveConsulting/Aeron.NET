...
public class BackupResponseEncoder
{
    ...
    public BackupResponseEncoder Wrap(IMutableDirectBuffer buffer, int offset)
    {
        this._buffer = buffer;
        this._offset = offset;
    ...
    {
        BackupResponseDecoder writer = new BackupResponseDecoder();
