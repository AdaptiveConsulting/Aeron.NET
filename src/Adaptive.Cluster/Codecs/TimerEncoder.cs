...
public class TimerEncoder
{
    ...
    private TimerEncoder _parentMessage;
    ...
    public TimerEncoder Wrap(IMutableDirectBuffer buffer, int offset)
    {
        this._buffer = buffer;
        this._offset = offset;
    ...
    public TimerEncoder WrapAndApplyHeader(
    ...
    public TimerEncoder CorrelationId(long value)
    {
    ...
    public TimerEncoder Deadline(long value)
    {
