...
namespace Adaptive.Agrona
{
    ...
    public static class EndianessConverter
    {
        ...
        /// <summary>
        /// Applies the specified endianess to an int16 (reverse bytes if input endianess is different from system's
        /// endianess)
        /// </summary>
        ...
        /// <summary>
        /// Applies the specified endianess to an uint16 (reverse bytes if input endianess is different from system's
        /// endianess)
        /// </summary>
        /// <param name="byteOrder">the endianess to apply</param>
        /// <param name="value">the value to be converted</param>
        ...
        /// <summary>
        /// Applies the specified endianess to an int32 (reverse bytes if input endianess is different from system's
        /// endianess)
        /// </summary>
        /// <param name="byteOrder">the endianess to apply</param>
        /// <param name="value">the value to be converted</param>
        ...
        /// <summary>
        /// Applies the specified endianess to an uint32 (reverse bytes if input endianess is different from system's
        /// endianess)
        /// </summary>
        /// <param name="byteOrder">the endianess to apply</param>
        /// <param name="value">the value to be converted</param>
        ...
        /// <summary>
        /// Applies the specified endianess to an uint64 (reverse bytes if input endianess is different from system's
        /// endianess)
        /// </summary>
        /// <param name="byteOrder">the endianess to apply</param>
        /// <param name="value">the value to be converted</param>
        ...
        /// <summary>
        /// Applies the specified endianess to an int64 (reverse bytes if input endianess is different from system's
        /// endianess)
        /// </summary>
        /// <param name="byteOrder">the endianess to apply</param>
        /// <param name="value">the value to be converted</param>
        ...
        /// <summary>
        /// Applies the specified endianess to a double (reverse bytes if input endianess is different from system's
        /// endianess)
        /// </summary>
        /// <param name="byteOrder">the endianess to apply</param>
        /// <param name="value">the value to be converted</param>
        ...
        /// <summary>
        /// Applies the specified endianess to an float (reverse bytes if input endianess is different from system's
        /// endianess)
        /// </summary>
        /// <param name="byteOrder">the endianess to apply</param>
        /// <param name="value">the value to be converted</param>
