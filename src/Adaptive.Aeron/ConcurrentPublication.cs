...
namespace Adaptive.Aeron
{
    ...
    /// are created via the <seealso cref="Aeron.AddPublication(string, int)"/> method, and messages are sent via one of
    /// the
    /// <seealso cref="Publication.Offer(UnsafeBuffer)"/> methods, or a <seealso cref="TryClaim(int, BufferClaim)"/> and
