...
namespace Adaptive.Aeron.LogBuffer
{
    ...
    {
        /// <summary>
        /// Handler for reading data that is coming from a log buffer. The frame will either contain a whole message or
        /// a fragment of a message to be reassembled. Messages are fragmented if greater than the frame for MTU in
        /// length.
        ///
