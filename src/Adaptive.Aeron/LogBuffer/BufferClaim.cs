...
namespace Adaptive.Aeron.LogBuffer
{
    ...
    /// commit.
    ///
    /// The claimed space is in <seealso cref="Buffer"/> between <seealso cref="Offset"/> and <seealso cref="Offset"/> +
    /// <seealso cref="Length"/>.
    ...
    public class BufferClaim
    {
        ...
        /// <summary>
        /// Put bytes into the claimed buffer space for a message. To write multiple parts then use
        /// <seealso cref="Buffer()"/>
        ...
        public void Abort()
        {
            ...
            _buffer.PutShort(
                HeaderFlyweight.TYPE_FIELD_OFFSET,
                (short)HeaderFlyweight.HDR_TYPE_PAD,
