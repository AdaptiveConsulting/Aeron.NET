...
{
    /// <summary>
    /// A means to capture an event of significance that does not require a stack trace, so it can be lighter-weight and
    /// take up less space in a <seealso cref="DistinctErrorLog"/> .
    /// </summary>
